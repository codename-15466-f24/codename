...
const common_names = [
	...
	maek.CPP('string_parsing.cpp'),
	maek.CPP('ReverseCipher.cpp'),
	maek.CPP('CaesarCipher.cpp'),
	maek.CPP('SubstitutionCipher.cpp'),
	maek.CPP('ToggleCipher.cpp'),
...
function init_maek() {
	...
	if (maek.OS === 'windows') {
		...
		DEFAULT_OPTIONS.CPP = ['g++', '-std=c++20', '-Wall', '-g'];
		DEFAULT_OPTIONS.LINK = ['g++', '-std=c++20', '-Wall', '-g'];
	} else if (maek.OS === 'macos') {
		DEFAULT_OPTIONS.CPP = ['clang++', '-std=c++17', '-Wall', '-Werror', '-Wno-deprecated', '-g'];
		DEFAULT_OPTIONS.LINK = ['clang++', '-std=c++17', '-Wall', '-Werror', '-Wno-deprecated', '-g'];
	}
